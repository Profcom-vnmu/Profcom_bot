...
namespace StudentUnionBot.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251010215213_AddMultipleFileAttachments")]
    partial class AddMultipleFileAttachments
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StudentUnionBot.Domain.Entities.Event", b =>
                {
                    ...
                    b.HasIndex("IsFeatured", "Status", "StartDate")
            ...
            modelBuilder.Entity("StudentUnionBot.Domain.Entities.News", b =>
                {
                    ...
                    b.HasIndex("IsArchived", "IsPublished")
                    ...
                    b.HasIndex("IsPublished", "IsPinned", "CreatedAt")
