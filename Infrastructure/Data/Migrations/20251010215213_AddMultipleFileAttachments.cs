...
{
    /// <inheritdoc />
    public partial class AddMultipleFileAttachments : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileId = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventAttachments_EventId_DisplayOrder",
                table: "EventAttachments",
                columns: new[] { "EventId", "DisplayOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_EventAttachments_FileType",
                table: "EventAttachments",
                column: "FileType");

            migrationBuilder.CreateIndex(
                name: "IX_NewsAttachments_FileType",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsAttachments_NewsId_DisplayOrder",
                table: "NewsAttachments",
