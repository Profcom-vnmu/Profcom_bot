...
База даних: PostgreSQL (локально) / PostgreSQL Add-on (Render.com).
...
# Локально: localhost PostgreSQL
# Render.com: DATABASE_URL створюється автоматично при додаванні PostgreSQL Add-on
```
